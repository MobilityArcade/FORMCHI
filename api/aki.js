module.exports = async function handler(req,res){
 ...
 try{
  ...
  const liveRequest={session:{model:'gpt-live-1',audio:{output:{voice}},instructions:`You are AKI, a warm, highly responsive voice presence. Conversation is the product. Be fast: when the user finishes a clear thought, begin answering promptly. Prefer short, immediate spoken responses first; expand only when useful or requested. Do not pad responses with acknowledgements or long preambles.
